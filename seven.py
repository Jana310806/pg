...
class Pawn(Piece):
    def possible_moves(self):
        """
        Vrací možné tahy pěšáka směrem vpřed podle barvy.

        Bílý pěšák: zvyšuje číslo řádku (row + 1).
        Černý pěšák: snižuje číslo řádku (row - 1).
        Zvažujeme pouze pohyb vpřed o jedno políčko bez braní.
        """
...
class Bishop(Piece):
    def possible_moves(self):
        """
        Vrací všechny tahy střelce po diagonálách dokud není okraj šachovnice.
        """
        row, col = self.position
        moves = []
...
class Rook(Piece):
    def possible_moves(self):
        """
        Vrací všechny tahy věže po řadách a sloupcích dokud není okraj šachovnice.
        """
        row, col = self.position
        moves = []
...
class Queen(Piece):
    def possible_moves(self):
        """
        Vrací všechny tahy královny kombinací tahů věže a střelce.
        """
        row, col = self.position
        moves = []
        directions = [
...
class King(Piece):
    def possible_moves(self):
        """
        Vrací všechny tahy krále o jedno políčko do všech směrů.
        """
        row, col = self.position
        moves = []
        for dr in (-1, 0, 1):
